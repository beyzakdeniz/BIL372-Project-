...
<body>
    ...
    <script>
        function redirectToAdmin() {
            window.location.href = 'BIL372-Project-/admin_home.php';
        }

        function redirectToTeacher() {
            window.location.href = 'BIL372-Project-/teacher_home.php';
        }

        function redirectToStudent() {
            window.location.href = 'BIL372-Project-/student_home.php';
        }
    </script>
